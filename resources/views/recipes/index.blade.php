...
<<<<<<< HEAD
            ...
            <span class="relative flex justify-center">
                ...
                <div class="pt-0 my-5 relative mx-auto text-gray-600">
                    <form action="{{ route('recipes.search') }}" method="GET" class="relative mx-auto text-gray-600">
                        <input class="border-2 border-gray-300 bg-white h-10 w-full px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="query" placeholder="Search">
